...
<body>
    ...
    <div id="blockText">
        <div class="row">
            <div class="col-md-12" id="body-text">
        ...
        <div class="row">
            <div class="col-md-12" id="body-text">
                <h3>An example chart is shown below, for Yahoo's stock price data from 2013 to 2016</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12" id="body-text">
            <?php
              require_once("config.php");
              $mysqli = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
              $getChart = $mysqli -> query("SELECT svg_string FROM Charts WHERE chartID = 40");
